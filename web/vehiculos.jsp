...
<%
    ...
    int disponibles = dao.listarVehiculosDisponibles().size();
    boolean alertaStock = disponibles <= 5;
%>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <script>
                                        $(document).ready(function () {
                                            ...
                                            $('#tablaVehiculos').DataTable({
                                                ...
                                                "columnDefs": [
                                                    {
                                                        "targets": 0, // columna ID (índice 0)
                                                        "type": "num", // ordenar como número
                                                        "render": function (data) {
                                                            return data.replace('#', ''); // quita el # para comparar
                                                        }
                                                    }
                                                ]
                                            });
            ...
            <% if (alertaStock) {%>
                                                    Swal.fire({
                                                        title: '⚠️ Stock bajo',
                                                        html: 'Solo quedan <strong><%= disponibles%></strong> vehículo(s) disponible(s) para alquilar.',
                                                        icon: 'warning',
                                                        confirmButtonColor: '#3b82f6',

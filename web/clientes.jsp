    ...
    <body class="bg-light">
                ...
                <div class="modal-content">
                    <form action="ClienteServlet" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group"><label>Nombre:</label><input type="text" name="txtNombre" id="txtNombre" class="form-control" placeholder="Ej. Juan Pérez" required></div>
                            <div class="form-group"><label>DUI:</label><input type="text" name="txtDui" id="txtDui" class="form-control" placeholder="00000000-0" required pattern="[0-9]{8}-[0-9]{1}"></div>
                            <div class="form-group"><label>Edad:</label><input type="number" name="txtEdad" id="txtEdad" class="form-control" placeholder="18" required min="18"></div>
                            <div class="form-group"><label>Teléfono:</label><input type="text" name="txtTelefono" id="txtTelefono" class="form-control" placeholder="7777-7777" required pattern="[267][0-9]{3}-[0-9]{4}"></div>
                        </div>
        ...
        <script>
                                $(document).ready(function () {
                                    ...
                                    // Mostrar alerta de éxito/error si existen parámetros en la URL
